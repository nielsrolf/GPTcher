...
class ConversationState():
    ...
    def start(self, message_raw: str):
        raise NotImplementedError()

    def respond(self, message_raw: str):
        raise NotImplementedError()
...
class ConversationState(ConversationState):
    ...
    def respond(self, message_raw: str):
        ...
        message.to_db()
        # asyncio.create_task(evaluate(message, self.context))
        # Create response
...
class WelcomeUser(ConversationState):
    ...
    def start(self):
        ...
        opener = new_conversation.start()
        self.user.set_state(new_conversation)
        return f"{welcome_message} {opener}"
